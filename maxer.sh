# Código modificado por MaxViajeYT      
...
mp3_array=("install_automatic1.mp3" "install_automatic2.mp3" "install_automatic3.mp3" "install_automatic4.mp3" "install_automatic5.mp3" "install_automatic6.mp3")
random_mp3=${mp3_array[$RANDOM % ${#mp3_array[@]}]}
if wget -q https://github.com/MaxViajeYT/MaxerBot-MD/raw/master/musicSH/"$random_mp3"; then
...
echo -e "\033[01;33mpkg install git -y\npkg install nodejs -y\npkg install ffmpeg -y\npkg install imagemagick -y\npkg install -y yarn\ngit clone https://github.com/MaxViajeYT/MaxerBot-MD\ncd MaxerBot-MD\nyarn install\nnpm install\nnpm start\033[0m"
exit 1
else
...
echo -e "\033[1;35m"
git clone https://github.com/MaxViajeYT/MaxerBot-MD.git
...
echo -e "\033[01;32m\033[01mIniciando MaxerBot!!\nStarting MaxerBot!!\n\033[0m"
npm start
