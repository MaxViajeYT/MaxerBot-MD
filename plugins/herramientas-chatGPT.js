...
let syms = `Actuaras como un Bot de WhatsApp el cual fue creado por MaxViajeYT, tu seras MaxerBot-MD`
...
try {
const syms1 = `Actuaras como un Bot de WhatsApp el cual fue creado por MaxViajeYT, tu seras MaxerBot-MD.`;
...
handler.command = /^(openai|chatgpt|ia|robot|openai2|chatgpt2|ia2|robot2|maxer|maxerbot)$/i;
