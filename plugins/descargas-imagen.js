...
if (!text) throw `️${lenguajeGB['smsAvisoMG']()}${mid.smsMalused7} *${usedPrefix + command} Homongusaurio*`
...
if (prohibited.some(word => m.text.toLowerCase().includes(word))) return m.reply('⚠️🚫Búsqueda prohibida🚫⚠️')      
try {
